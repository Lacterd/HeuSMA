...
class HeuristicProducerUI(QWidget):
    ...
    def initUI(self):
        ...
        self.TextBrowser_SampleSelect.setHorizontalHeaderLabels(['Data','Peak List','Select Calibants','Calibrants path'])
        #self.TextBrowser_SampleSelect.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        #self.TextBrowser_SampleSelect.horizontalHeader().setSectionResizeMode(1, QHeaderView.ResizeMode.Stretch)
        #self.TextBrowser_SampleSelect.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
    ...
    def SelectSampleFile(self):
        ...
        for i in FileName:
            ...
            '''
            self.TextBrowser_SampleSelect.setItem(self.TextBrowser_SampleSelect.rowCount()-1,0,LineEdit_Data)
            self.TextBrowser_SampleSelect.setItem(self.TextBrowser_SampleSelect.rowCount()-1,1,LineEdit_PeakList)
            '''
            '''
